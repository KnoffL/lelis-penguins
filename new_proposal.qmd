...
- Calculate point guessers for depressive symptoms of the general population for each year, Calculate the differences between the high education group and general education group for each year and try to fit a linear regression model –\> did the difference decline over the years?
